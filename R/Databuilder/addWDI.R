...
wbData=WDI(country='all', indicator=c("BX.KLT.DINV.CD.WD", "NY.GDP.PCAP.KD", "NY.GDP.PCAP.KD.ZG", "NY.GDP.MKTP.CD", "NY.GDP.MKTP.KD", "NY.GDP.MKTP.KD.ZG"), start=1989, end=2010, extra=T)
