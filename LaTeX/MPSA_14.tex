...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[Effects of Subnational Conflict]{Effect of Political Instability on Economic Development}
\author[Minhas \& Radford]{Shahryar Minhas \& Benjamin Redfard}
\institute[Duke University]
{
{\emph{benjamin.radford@duke.edu \& shahryar.minhas@duke.edu}} \\
\medskip
Duke University 
}
\date{\today}
