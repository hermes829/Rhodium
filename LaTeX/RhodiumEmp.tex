...
The results of this model are shown below in figure~\ref{fig:civWarCoefplot}. We will eschew discussing the controls since the primary purpose of this analysis is to determine a baseline effect for civil war. 

\begin{figure}
	\resizebox{.45\textwidth}{!}{\input{civWarCoefPlot.tex}}
